...
class lists {
  ...
  static const List<String> bca_sem2 = [
    ...
    'EMERGING TRENDS AND INFORMATION TECHNOLOGY',
    'OPERATING SYSTEM-1',
    'PROGRAMMING SKILLS',
  ...
  static const bba_sem2 = [
    ...
    'MANAGING MSES',
    'ENVIRONMENT & ECOLOGIC MANAGEMENT',
    'FAMILY BUSINESS MANAGEMENT',
    'LANGUAGE PROFICIENCY AND LIFE SKILLS 2',
    'VALUE EDUCATION IN BAHTIYAR KNOWLEDGE SYSTEM'
  ];
  ...
  static const b_com_sem3 = [
    ...
    'MACRO ECONOMICS 3',
    'ACCOUNTANCY AND TAXATION 3',
    'BUSINESS ADMINISTRATION 3',
    'ADVANCED ACCOUNTING AND AUDITING 1',
    'ADVANCED ACCOUNTING AND AUDITING 2',
    'STATISTICS 3 ',
